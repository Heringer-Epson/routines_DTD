...
class Plot_Dcolor(object):
    ...
    Description:
    ------------
    Makes a histogram of the Dcolor space (using absolute magnitudes). A
    scaled histogram of the hosts in the same parameter space is overplotted.
    ...
    Outputs:
    --------
    ./../../../OUTPUT_FILES/RUNS/$RUN_DIR/FIGURES/Dcolor_hist.pdf
    """          
    ...
    def manage_output(self):
        if self._inputs.save_fig:
            fpath = self._inputs.subdir_fullpath + 'FIGURES/Dcolor_hist.pdf'
