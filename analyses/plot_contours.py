...
def draw(_ax,_fpath,_c):
    ...
    stats.plot_contour(_ax, np.log10(x), y, z,c=_c, add_max=True)
...
class Make_Fig(object):
    ...
    def make_legend(self):
        self.ax1.plot(
          ...
          marker='None', label=r'M12-$\mathrm{VESPA}$')
        self.ax1.plot(
        ...
        self.ax1.legend(
          ...
          handlelength=1.5, handletextpad=.8, loc=4, bbox_to_anchor=(1.02, -0.05)) 
