...
def draw(fig, _ax1, _ax2, _fpath, _c):
    ...
    stats.plot_contour(_ax1, np.log10(x), y, z, c=_c, add_max=False)
    stats.plot_contour_colorbar(
      fig, _ax2, s1, s2, ln_L, np.log10(A), cmap=cmap,
      cbar_label=r'$\mathrm{log}\, A$', fs=fs)         
...
class Make_Fig(object):
    ...
    def set_fig_frame(self):
        ...
        self.ax1.set_xlabel(r'$\mathrm{log}\, A$', fontsize=fs + 4)
